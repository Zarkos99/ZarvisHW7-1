// derek_LED.cpp is the implementation file to the header derek_LED.h provided.
// This file implements an object oriented method for turning the usr LEDS 0-3 on, off, 
// flashing them, or obtaining their status.
#include "derek_LED.h"
